...
def sample():
    ...
    teacher = HypothesisAwareSampleProbabilisticTeacher(synchronic_model, 
                                                        ...
                                                        max_seq_length = 4, 
                                                        sample_size = 100)
    #time bound is set to 30 seconds
    ...
    df.to_csv("./case_studies/case_study_2_generate_floating_point/compare_distribution_one_digit_mask_floating_point_length_n/results/PDFA_10k_length_n.csv", index=False)
